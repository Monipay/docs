...
cover: https://cdn.hashnode.com/uploads/covers/6572eb4aa09b3311fdb7ba14/b709a450-b0a7-44fa-ba28-9070bbfaa7c8.png
...
Our solution was to embrace multi-chain rather than abstract it away. We run separate optimised payment flows for each chain. Users pick their preferred network once in settings. moniTagâ„¢ resolves to the correct address for that network. The user sees a consistent experience. Under the hood, it is three different payment systems that we maintain and improve independently.
...
**Personal payments** are live. Send USDC to any moniTagâ„¢ on Base. Send USDT to any moniTagâ„¢ on BSC. Scan a QR code to pay a merchant. Receive payments via your branded moniTagâ„¢ QR. Full [transaction history](https://monipay.xyz) with real-time sync.
...
A market trader who cannot afford a â‚¦30,000 POS terminal can download Monipay, create a moniTagâ„¢ in three minutes, and start accepting digital payments today. That is the product I wanted to exist when I started building.

[**MoniBot AI**](https://monipay.xyz/monibot) is live on Twitter/X, Discord, and Telegram. It processes real on-chain payments right now. We were publicly building this before any funded competitor entered the space.
...
Create your moniTagâ„¢ at [monipay.xyz](https://monipay.xyz). Read [how it works](https://monipay.xyz/how-it-works). Look at the [use cases](https://monipay.xyz/use-cases). Try [MoniBot AI](https://monipay.xyz/monibot).
...
**Samuel Chiedozie***Founder, Monipay*[*@jadeofwallstreet*](https://twitter.com/jadeofwallstreet)

* * *

*Monipay is live on* [*Base*](https://monipay.xyz/base) *and* [*BSC*](https://monipay.xyz/bsc)*. Solana coming soon.* [*Read the docs*](https://monipay.xyz/docs)*.* [*View the deck*](https://monipay.xyz/deck)*.*
...
**Meta description:** Monipay replaces wallet addresses with moniTagsâ„¢, eliminates gas fees, and introduces MoniBot AI for conversational on-chain payments. Here is the full story of what we are building and why.